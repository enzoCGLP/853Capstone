...
reg_payload = {
    ...
    { 
      ...
      "discoverable": False, # Is the object discoverable in the resource directory. Default Talse. Set to False (DISCOVER not implemented yet)
      ...
      { 
        ...
        "discoverable": False, # Is the resource discoverable in the resource directory. Default Talse. Set to False (DISCOVER not implemented yet)
        "racc": "0", # Allowed racc actions for this resource.
        "rmod": "0"  #rmod options for this resource.
        # Extra attributes area of the resource (key/value pairs directly included in the CBOR map)
      }
      ]
    }]
} 
